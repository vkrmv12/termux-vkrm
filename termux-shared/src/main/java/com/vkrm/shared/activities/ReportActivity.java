package com.vkrm.shared.activities;
...
import com.vkrm.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.vkrm.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.vkrm.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
