...
import com.vkrm.R;
import com.vkrm.app.event.SystemEventReceiver;
import com.vkrm.app.terminal.TermuxTerminalSessionActivityClient;
import com.vkrm.app.terminal.TermuxTerminalSessionServiceClient;
import com.vkrm.shared.termux.plugins.TermuxPluginUtils;
import com.vkrm.shared.data.IntentUtils;
import com.vkrm.shared.net.uri.UriUtils;
import com.vkrm.shared.errors.Errno;
import com.vkrm.shared.shell.ShellUtils;
import com.vkrm.shared.shell.command.runner.app.AppShell;
...
import com.vkrm.shared.termux.shell.TermuxShellUtils;
import com.vkrm.shared.termux.TermuxConstants;
import com.vkrm.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.vkrm.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
...
import com.vkrm.shared.notification.NotificationUtils;
...
import com.vkrm.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.vkrm.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.vkrm.shared.R.string.error_execution_cancelled))) {
