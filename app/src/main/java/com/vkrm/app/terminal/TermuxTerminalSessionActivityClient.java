...
import com.vkrm.shared.termux.terminal.io.BellHandler;
import com.vkrm.shared.logger.Logger;
import com.vkrm.terminal.TerminalColors;
import com.vkrm.terminal.TerminalSession;
import com.vkrm.terminal.TerminalSessionClient;
import com.vkrm.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.vkrm/com.vkrm.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
